...

{
  ...
  test.asserts.warnings.expected = [
    ...
    "The option `programs.git.diff-highlight.enable' defined in ${lib.showFiles options.programs.git.diff-highlight.enable.files} has been changed to `programs.diff-highlight.enable' that has a different type. Please read `programs.diff-highlight.enable' documentation and update your configuration accordingly."
