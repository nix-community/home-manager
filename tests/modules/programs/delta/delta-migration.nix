...

{
  ...
  test.asserts.warnings.expected = [
    ...
    "The option `programs.git.delta.enable' defined in ${lib.showFiles options.programs.git.delta.enable.files} has been changed to `programs.delta.enable' that has a different type. Please read `programs.delta.enable' documentation and update your configuration accordingly."
