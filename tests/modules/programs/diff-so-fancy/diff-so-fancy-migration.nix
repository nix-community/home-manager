...

{
  ...
  test.asserts.warnings.expected = [
    ...
    "The option `programs.git.diff-so-fancy.enable' defined in ${lib.showFiles options.programs.git.diff-so-fancy.enable.files} has been changed to `programs.diff-so-fancy.enable' that has a different type. Please read `programs.diff-so-fancy.enable' documentation and update your configuration accordingly."
