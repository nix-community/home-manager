...
set_opts=(
  ...
  NO_HIST_IGNORE_DUPS NO_HIST_IGNORE_SPACE NO_HIST_SAVE_NO_DUPS
  NO_INC_APPEND_HISTORY NO_INC_APPEND_HISTORY_TIME NO_SHARE_HISTORY AUTO_LIST
  AUTO_PARAM_SLASH AUTO_PUSHD ALWAYS_TO_END CORRECT HIST_FCNTL_LOCK HIST_VERIFY
  INTERACTIVE_COMMENTS MENU_COMPLETE PUSHD_IGNORE_DUPS PUSHD_TO_HOME
