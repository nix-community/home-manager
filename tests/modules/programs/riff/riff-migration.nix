...

{
  ...
  test.asserts.warnings.expected = [
    ...
    "The option `programs.git.riff.enable' defined in ${lib.showFiles options.programs.git.riff.enable.files} has been changed to `programs.riff.enable' that has a different type. Please read `programs.riff.enable' documentation and update your configuration accordingly."
