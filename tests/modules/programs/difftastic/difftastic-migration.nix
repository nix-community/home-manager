...

{
  ...
  test.asserts.warnings.expected = [
    ...
    "The option `programs.git.difftastic.enable' defined in ${lib.showFiles options.programs.git.difftastic.enable.files} has been changed to `programs.difftastic.enable' that has a different type. Please read `programs.difftastic.enable' documentation and update your configuration accordingly."
