{
  ...
  nmt.script = ''
    ...
    assertFileContains home-files/.java/.userPrefs/ninjabrainbot/prefs.xml 'key="overlay_hide_delay" value="45.0"'
    assertFileContains home-files/.java/.userPrefs/ninjabrainbot/prefs.xml 'key="sigma" value="0.05"'
