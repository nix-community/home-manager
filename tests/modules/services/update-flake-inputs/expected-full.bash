...
export PATH="@git-minimal@/bin:/nix/store/00000000000000000000000000000000-jq/bin:/nix/store/00000000000000000000000000000000-coreutils/bin:@git-minimal@/bin:$PATH"
...
afterUpdateCommands() {
  command arg1 arg2 && other_command arg1
}
