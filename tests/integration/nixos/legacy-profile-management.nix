  ...
  nodes.machine = { ... }: {
    ...
    specialisation = {
      legacy.configuration = {
        home-manager = {
          # Assert that we expect the option to default to true due to the Home
          # Manager state version setup.
          enableLegacyProfileManagement = pkgs.lib.mkOptionDefault true;
      ...
      modern.configuration = {
        home-manager = {
          # Force modern profile management.
