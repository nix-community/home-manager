  ...
  options = {
    programs.fish = {
      ...
      package = mkOption {
        ...
        description = ''
          fish package to install - can be used to change the version.
        '';
        type = types.package;
      };
        ...
        generateCompletions = package: pkgs.runCommand
          ...
          ''
            ...
            if [ -d $src/share/man ]; then
              find $src/share/man -type f | xargs python ${cfg.package}/share/fish/tools/create_manpage_completions.py --directory $out >/dev/null
            fi
          '';
      in
        destructiveSymlinkJoin {
          name = "${config.home.username}-fish-completions";
          paths = map generateCompletions (sort (a: b: (a.meta.priority or 0) > (b.meta.priority or 0)) config.home.packages);
        };
