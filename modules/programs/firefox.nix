...
let
  ...
  mkUserJs = arkenfox: prefs: extraPrefs: bookmarks:
    let
    ...
    in ''
      ...
      ${if arkenfox then arkenfoxUserJs else ""}
      ...
      profiles = mkOption {
        type = types.attrsOf (types.submodule ({ config, name, ... }: {
          options = {
            ...
            enableArkenfoxUserjs = mkOption {
              type = types.bool;
              default = false;
              description = ''
                Wether to add arkenfox user.js template (see <link xlink:href="https://github.com/arkenfox/user.js">)
                to <filename>user.js</filename>. The template can be customized by adding overrides to the
                <literal>profile.settings</literal> option.
              '';
            };
  ...
  config = mkIf cfg.enable {
    ...
    home.file = mkMerge ([{
      ...
      "${profilesPath}/${profile.path}/user.js" = mkIf (profile.settings != { }
        ...
        || profile.enableArkenfoxUserjs) {
          text = mkUserJs profile.enableArkenfoxUserjs profile.settings
            profile.extraConfig profile.bookmarks;
        };
