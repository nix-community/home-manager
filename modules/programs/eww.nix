...
in
{
  ...
  options.programs.eww = {
    ...
    configDir = lib.mkOption {
      ...
      description = ''
        ...
        Deprecated Please use instead yuckConfig & scssConfig.
      '';
    };
  ...
  config =
    ...
    mkIf cfg.enable (mkMerge [
      {
        #TODO: Remove option and deprecate the assert in 26.11
        assertions = [
          {
            assertion = cfg.configDir != null;
            message = "eww: configDir is depercated use yuckConfig & scssConfig instead.";
          }
        ];
