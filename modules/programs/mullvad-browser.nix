...
in {
  meta.maintainers = [ maintainers.rycee maintainers.heywoodlh ];
  ...
  options = {
    programs.mullvad-browser = {
      ...
      package = mkOption {
        ...
        description = ''
          The Mullvad Browser package to use. Only used on Linux. On MacOS, install the mullvad-browser Homebrew Cask.
        '';
      };
      ...
      profiles = mkOption {
        type = types.attrsOf (types.submodule ({ config, name, ... }: {
          options = {
            ...
            settings = mkOption {
              ...
              '';
              description = ''
                Attribute set of Firefox preferences for Mullvad Browser.
            ...
            userChrome = mkOption {
              type = types.lines;
              default = "";
              description = "Custom Mullvad Browser user chrome CSS.";
              example = ''
            ...
            userContent = mkOption {
              type = types.lines;
              default = "";
              description = "Custom Mullvad Browser user content CSS.";
              example = ''
            ...
            extensions = mkOption {
              ...
              '';
              description = ''
                List of Firefox add-on packages to install for this
        ...
        default = { };
        description = "Attribute set of Mullvad Browser profiles.";
      };
