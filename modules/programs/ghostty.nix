  ...
  options.programs.ghostty =
    ...
    in
    {
      ...
      extraConfig = lib.mkOption {
        ...
        '';
        description = ''
          Additional configuration written to {file}`$XDG_CONFIG_HOME/ghostty/config`.
    ...
    lib.mkMerge [
      {
        ...
        xdg.configFile =
          ...
          lib.mkMerge [
            {
              "ghostty/config" = lib.mkIf (cfg.settings != { } || cfg.extraConfig != "") {
                text = ''
                  # Generated by Home Manager.
                  # See <https://ghostty.org/docs/config/reference>
                  ${lib.generators.toKeyValue keyValueSettings cfg.settings}
                  ${cfg.extraConfig}
                '';
