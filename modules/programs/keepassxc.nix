  ...
  options.programs.keepassxc = {
    ...
    settings = lib.mkOption {
      ...
      description = ''
        ...
        into the Nix store and KeePassXC will report that there was an access
        error for its configuration file. This is expected and can not be fixed
        in a way that aligns with Home Manager's principles. See #8257 for more
        details.
        :::
      '';
    };
