...
let
  ...
  includeTheme = location:
    ...
    else if isString location then "include ${pkgs.taskwarrior}/share/doc/task/rc/${location}.theme"
  ...
  options = {
    programs.taskwarrior = {
      ...
      config = mkOption {
        ...
        '';
        description = ''
          Key-value configuration written to <filename>~/.taskrc</filename>
        '';
      };
      ...
      extraConfig = mkOption {
        ...
        default = "";
        description = ''
          Additional content written at the end of <filename>~/.taskrc</filename>
        '';
      };
    };
  };
