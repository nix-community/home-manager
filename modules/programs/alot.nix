  ...
  tagSubmodule = types.submodule {
    options = {
      translated = mkOption {
        ...
        description = ''
          Fixed string representation for this tag.
          The tag can be hidden from view, if the key translated is set to ‘’, the empty string.
        '';
      };
      translation = mkOption {
        ...
        default = null;
        description = ''
          A pair of strings that define a regular substitution to compute
          the string representation on the fly using re.sub.
        '';
      };
      normal = mkOption {
        type = types.nullOr types.str;
  ...
  configFile =
    ...
    in
      ''
        ...
        ${generators.toKeyValue { inherit mkKeyValue; } cfg.extraConfigStructured}
        ${cfg.extraConfig}
        [tags]
      ''
      + (
...

{
  options.programs.alot = {
    ...
    extraConfigStructured = mkOption {
