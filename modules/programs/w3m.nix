...
in
{
  ...
  options.programs.w3m = {
    ...
    finalPackage = mkOption {
      ...
      readOnly = true;
      description = ''
        Final W3m package that respects homePage, home.preferXdgDirectories,
        and w3mImg2Sixel.
      '';
    };
  ...
  config =
    let
      # wraps w3m package to avoid polluting the user environment with its
      # environment variables and extra packages.
