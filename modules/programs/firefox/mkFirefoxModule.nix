        ...
        options = {
          ...
          preConfig = mkOption {
            ...
            description = ''
              ...
              [{option}`programs.firefox.profiles.<name>.settings`](#opt-programs.firefox.profiles._name_.settings).

              Use [{option}`programs.firefox.profiles.<name>.extraConfig`](#opt-programs.firefox.profiles._name_.extraConfig),
