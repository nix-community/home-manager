          ...
          { config, name, ... }:
          {
            ...
            options = {
              ...
              chromeDir = mkOption {
                ...
                default = null;
                description = ''
                  Directory containing the chrome directory. This is used to
                  store userChrome.css and userContent.css.
                '';
              };
            ...
            config = {
              assertions = [
                ...
                {
                  assertion = config.chromeDir != null -> (config.userChrome == "" && config.userContent == "");
                  message = ''
                    ...
                    Either use 'chromeDir' to specify an entire directory with your chrome files,
                    or set 'userChrome' and 'userContent' individually.
                  '';
                }
            ...
            [
              {
                ...
                "${profilesPath}/${profile.path}/chrome" = mkIf (profile.chromeDir != null) {
                  source = profile.chromeDir;
                };
