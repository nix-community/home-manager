      ...
      mkOption {
        type = types.attrTag {
          ...
          moveColumnToWorkspaceDown = mkPropOptions {
            focus = mkBoolOption "Follow the column.";
          ...
          moveColumnToWorkspace = mkArgActionOption {
            workspace = mkWorkspaceOption "Workspace to move to.";
            focus = mkBoolOption "Follow the column.";
          } "workspace" "Move the focused column to a workspace by reference (index or name).";
          moveWorkspaceDown = mkPlainActionOption "Move the focused workspace down.";
          moveWorkspaceUp = mkPlainActionOption "Move the focused workspace up.";
          moveWorkspaceToIndex = mkArgActionOption {
            index = mkNullOption types.ints.unsigned "Index to move to.";
          } "index" "Move the focused workspace to a specific index on its monitor.";
          setWorkspaceName = mkArgActionOption {
            name = mkNullOption types.str "New workspace name.";
          } "name" "Set the name of the focused workspace.";
          unsetWorkspaceName = mkPlainActionOption "Unset the name of the focused workspace.";
          focusMonitorLeft = mkPlainActionOption "Focus the monitor to the left.";
          focusMonitorRight = mkPlainActionOption "Focus the monitor to the right.";
          focusMonitorDown = mkPlainActionOption "Focus the monitor below.";
          focusMonitorUp = mkPlainActionOption "Focus the monitor above.";
          focusMonitorPrevious = mkPlainActionOption "Focus the previous monitor.";
          focusMonitorNext = mkPlainActionOption "Focus the next monitor.";
          focusMonitor = mkArgActionOption {
            monitor = mkNullOption types.str "Name of monitor to focus.";
          } "monitor" "Focus a monitor by name.";
          moveWindowToMonitorLeft = mkPlainActionOption "Move the focused window to the monitor to the left.";
          moveWindowToMonitorRight = mkPlainActionOption "Move the focused window to the monitor to the right.";
          moveWindowToMonitorDown = mkPlainActionOption "Move the focused window to the monitor below.";
          moveWindowToMonitorUp = mkPlainActionOption "Move the focused window to the monitor above.";
          moveWindowToMonitorPrevious = mkPlainActionOption "Move the focused window to the previous monitor.";
          moveWindowToMonitorNext = mkPlainActionOption "Move the focused window to the next monitor.";
          moveWindowToMonitor = mkArgActionOption {
            monitor = mkNullOption types.str "Monitor to move to.";
          } "monitor" "Move the focused window to a specific monitor.";
          moveColumnToMonitorLeft = mkPlainActionOption "Move the focused column to the monitor to the left.";
          moveColumnToMonitorRight = mkPlainActionOption "Move the focused column to the monitor to the right.";
          moveColumnToMonitorDown = mkPlainActionOption "Move the focused column to the monitor below.";
          moveColumnToMonitorUp = mkPlainActionOption "Move the focused column to the monitor above.";
          moveColumnToMonitorPrevious = mkPlainActionOption "Move the focused column to the previous monitor.";
          moveColumnToMonitorNext = mkPlainActionOption "Move the focused column to the next monitor.";
          moveColumnToMonitor = mkArgActionOption {
            monitor = mkNullOption types.str "Monitor to move to.";
          } "monitor" "Move the focused column to a specific monitor.";
          setWindowWidth = mkArgActionOption {
            width = mkNullOption types.str "New width.";
          } "width" "Change the width of the focused window.";
          setWindowHeight = mkArgActionOption {
            height = mkNullOption types.str "New height.";
          } "height" "Change the height of the focused window.";
          resetWindowHeight = mkPlainActionOption "Reset the height of the focused window back to automatic.";
          switchPresetColumnWidth = mkPlainActionOption "Switch between preset column widths.";
          switchPresetColumnWidthBack = mkPlainActionOption "Switch between preset column widths backwards.";
          switchPresetWindowWidth = mkPlainActionOption "Switch between preset window widths.";
          switchPresetWindowWidthBack = mkPlainActionOption "Switch between preset window widths backwards.";
          switchPresetWindowHeight = mkPlainActionOption "Switch between preset window heights.";
          switchPresetWindowHeightBack = mkPlainActionOption "Switch between preset window heights backwards.";
          maximizeColumn = mkPlainActionOption "Toggle the maximized state of the focused column.";
          maximizeWindowToEdges = mkPlainActionOption "Toggle the maximized-to-edges state of the focused window.";
          setColumnWidth = mkArgActionOption {
            width = mkNullOption types.str "The new width.";
          } "width" "Change the width of the focused column.";
          expandColumnToAvailableWidth = mkPlainActionOption "Expand the focused column to space not taken up by other fully visible columns.";
          ...
          moveWorkspaceToMonitorLeft = mkPlainActionOption "Move the focused workspace to the monitor to the left.";
          moveWorkspaceToMonitorRight = mkPlainActionOption "Move the focused workspace to the monitor to the right.";
          moveWorkspaceToMonitorDown = mkPlainActionOption "Move the focused workspace to the monitor below.";
          moveWorkspaceToMonitorUp = mkPlainActionOption "Move the focused workspace to the monitor above.";
          moveWorkspaceToMonitorPrevious = mkPlainActionOption "Move the focused workspace to the previous monitor.";
          moveWorkspaceToMonitorNext = mkPlainActionOption "Move the focused workspace to the next monitor.";
          moveWorkspaceToMonitor = mkArgActionOption {
            monitor = mkNullOption types.str "Monitor to move to.";
          } "monitor" "Move the focused workspace to a specific monitor.";
          toggleDebugTint = mkPlainActionOption "Toggle a debug tint on windows.";
          debugToggleOpaqueRegions = mkPlainActionOption "Toggle visualization of render element opaque regions.";
          debugToggleDamage = mkPlainActionOption "Toggle visualization of output damage.";
          toggleWindowFloating = mkPlainActionOption "Move the focused window between the floating and the tiling layout.";
          moveWindowToFloating = mkPlainActionOption "Move the focused window to the floating layout.";
          moveWindowToTiling = mkPlainActionOption "Move the focused window to the tiling layout.";
          focusFloating = mkPlainActionOption "Switches focus to the floating layout.";
          focusTiling = mkPlainActionOption "Switches focus to the tiling layout.";
          switchFocusBetweenFloatingAndTiling = mkPlainActionOption "Toggles the focus between the floating and the tiling layout.";
          moveFloatingWindow = mkPropOptions {
            x = mkNullOption (types.strMatching "(-|\\+)?[0-9]+(\\.[0-9]+)?%?") "X position. Prefix with +/- to adjust relative to current position. Suffix with % to use in proportion to the workspace width.";
            y = mkNullOption (types.strMatching "(-|\\+)?[0-9]+(\\.[0-9]+)?%?") "Y position. Prefix with +/- to adjust relative to current position. Suffix with % to use in proportion to the workspace height.";
          } "Move the floating window on screen.";
          toggleWindowRuleOpacity = mkPlainActionOption "Toggle the opacity of the focused window.";
          setDynamicCastWindow = mkPlainActionOption "Set the dynamic cast target to the focused window.";
          setDynamicCastMonitor = mkArgActionOption {
            monitor = mkNullOption types.str "Name of the output to target.";
          } "monitor" "Set the dynamic cast target to the focused monitor.";
          clearDynamicCastTarget = mkPlainActionOption "Clear the dynamic cast target, making it show nothing.";
          toggleOverview = mkPlainActionOption "Toggle (open/close) the Overview.";
          openOverview = mkPlainActionOption "Open the Overview.";
