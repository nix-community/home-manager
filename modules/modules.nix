...
let
  ...
  allModules = [
    ...
    (loadModule ./programs/bash/bash.nix { })
    ...
    (loadModule ./programs/zsh/zsh.nix { })
    (loadModule ./services/blueman-applet.nix { })
    (loadModule ./services/x11/compton.nix { })
    (loadModule ./services/dunst.nix { })
    (loadModule ./services/misc/dwm-status.nix { condition = hostPlatform.isLinux; })
    (loadModule ./services/editors/emacs.nix { condition = hostPlatform.isLinux; })
    (loadModule ./services/flameshot.nix { })
    (loadModule ./services/getmail.nix { condition = hostPlatform.isLinux; })
    (loadModule ./services/desktops/gnome3/gnome-keyring.nix { })
    (loadModule ./services/gpg-agent.nix { })
    (loadModule ./services/search/hound.nix { condition = hostPlatform.isLinux; })
    (loadModule ./services/imapnotify.nix { condition = hostPlatform.isLinux; })
    (loadModule ./services/network-filesystems/kbfs.nix { })
    (loadModule ./services/kdeconnect.nix { })
    (loadModule ./services/keepassx.nix { })
    (loadModule ./services/networking/keybase.nix { })
    (loadModule ./services/development/lorri.nix { condition = hostPlatform.isLinux; })
    (loadModule ./services/mbsync.nix { })
    (loadModule ./services/audio/mpd.nix { })
    (loadModule ./services/audio/mpdris2.nix { condition = hostPlatform.isLinux; })
    ...
    (loadModule ./services/x11/redshift.nix { })
    ...
    (loadModule ./services/x11/sxhkd.nix { condition = hostPlatform.isLinux; })
    (loadModule ./services/syncthing.nix { })
    (loadModule ./services/taffybar.nix { })
    (loadModule ./services/network-filesystems/tahoe.nix { })
    (loadModule ./services/taskwarrior-sync.nix { condition = hostPlatform.isLinux; })
    (loadModule ./services/udiskie.nix { })
    (loadModule ./services/x11/unclutter.nix { })
    (loadModule ./services/x11/window-managers/awesome.nix { })
    (loadModule ./services/x11/window-managers/i3.nix { })
    (loadModule ./services/x11/window-managers/xmonad.nix { })
