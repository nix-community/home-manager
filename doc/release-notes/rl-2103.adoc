...
* The systemd activation is now handled by
https://gitlab.com/rycee/sd-switch[sd-switch], a program that stops,
starts, reloads, etc. systemd units as necessary to match the new Home
